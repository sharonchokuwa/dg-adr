...
def get_dataset(cfg):
    ...
    if cfg.ALGORITHM == 'GDRNet':
        ...
        train_dataset = FundusDataset(root = cfg.DATASET.ROOT, source_domains= cfg.DATASET.SOURCE_DOMAINS, target_domains = cfg.DATASET.TARGET_DOMAINS, \
                                mode = 'train', trans_basic=train_ts, use_aug=cfg.USE_SYN)
        val_dataset = FundusDataset(root = cfg.DATASET.ROOT, source_domains=cfg.DATASET.SOURCE_DOMAINS, target_domains = cfg.DATASET.TARGET_DOMAINS, \
                                mode = 'val', trans_basic=test_ts)
        test_dataset = FundusDataset(root = cfg.DATASET.ROOT, source_domains= cfg.DATASET.SOURCE_DOMAINS, target_domains = cfg.DATASET.TARGET_DOMAINS, \
                                mode = 'test', trans_basic=test_ts)
...
def get_transform(cfg):
    ...
    if cfg.TRIVIAL_AUG: #TrivialAugmentWide
