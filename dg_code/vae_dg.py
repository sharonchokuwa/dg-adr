...
class ResNet_VAE(nn.Module):
    def __init__(self, input_shape, num_classes, cfg, fc_hidden1=1024, fc_hidden2=768, CNN_embed_dim=256):
        super(ResNet_VAE, self).__init__()
        self.fc_hidden1, self.fc_hidden2, self.CNN_embed_dim = fc_hidden1, fc_hidden2, CNN_embed_dim
        self.num_classes = num_classes
        self.loss_multiplier_y = 50000
        self.loss_multiplier_kl = 50000
        ...
        # encoding components
        self.resnet = models.get_net(cfg)
        in_features = 2048
