...
from semantic_aug.datasets.fundus import FundusDataset
...
PRETRAINED_MODEL_PATHS = {
    "no_diabetic_retinopathy": "path_to/finetune_dreambooth/train_outputs_checkpoints/grade_0", 
    "mild_diabetic_retinopathy": "path_to/finetune_dreambooth/train_outputs_checkpoints/grade_1", 
    "moderate_diabetic_retinopathy": "path_to/finetune_dreambooth/train_outputs_checkpoints/grade_2", 
    "severe_diabetic_retinopathy": "path_to/finetune_dreambooth/train_outputs_checkpoints/grade_3", 
    "proliferative_diabetic_retinopathy": "path_to/finetune_dreambooth/train_outputs_checkpoints/grade_4", 
}
...
def parse_args():
    ...
    parser.add_argument("--dataset", type=str, default="fundus", 
                        choices=["fundus", "spurge", "imagenet", "coco", "pascal"])
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if global_step % args.checkpointing_steps == 0:
                ...
                accelerator.save_state(os.path.join(args.output_dir, 'checkpoints', f'checkpoint_{global_step}'))
...
if __name__ == "__main__":
    ...
    task = Task.init(project_name='Stable Diffusion', 
    ...
    for seed, examples_per_class in options.tolist():
        ...
        for idx in range(len(train_dataset)):
            ...
            path = os.path.join(output_dir, "extracted", path, name, f"{idx}.jpg")
        ...
        for class_name in train_dataset.class_names:
            ...
            args.pretrained_model_name_or_path = PRETRAINED_MODEL_PATHS[formatted_name]
            args.output_dir = os.path.join(args.output_dir, PRETRAINED_MODEL_PATHS[formatted_name])
