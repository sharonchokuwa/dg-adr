...
--out="./generated_fundus_augs/ddr/0" \
...
--data_dir="./datasets/images/ddr" \
--dr_grade=0 \
--seed=0 \
--examples-per-class=6263 \
--num-synthetic=10 \
...
# class 1
python generate_fundus_augmentations.py \
--out="./generated_fundus_augs/ddr/1" \
...
# class 2
python generate_fundus_augmentations.py \
--out="./generated_fundus_augs/ddr/2" \
...
# class 3
python generate_fundus_augmentations.py \
--out="./generated_fundus_augs/ddr/3" \
...
# class 4
python generate_fundus_augmentations.py \
--out="./generated_fundus_augs/ddr/4" \
