...
--out="./generated_fundus_aug/idrid/0" \
...
--data_dir="./datasets/images/idrid" \
--dr_grade=0 \
--seed=0 \
--examples-per-class=68 \
--num-synthetic=10 \
...
# class 1
python generate_fundus_augmentations.py \
--out="./generated_fundus_aug/idrid/1" \
...
# # class 2
python generate_fundus_augmentations.py \
--out="./generated_fundus_aug/idrid/2" \
...
# # class 3
python generate_fundus_augmentations.py \
--out="./generated_fundus_aug/idrid/3" \
...
# # class 4
python generate_fundus_augmentations.py \
--out="./generated_fundus_aug/idrid/4" \
