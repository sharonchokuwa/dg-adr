...
--out="./generated_fundus_augs/aptos/0" \
...
--data_dir="./datasets/images/aptos" \
--dr_grade=0 \
--seed=0 \
--examples-per-class=1801 \
--num-synthetic=10 \
...
# # class 1
python generate_fundus_augmentations.py \
--out="./generated_fundus_augs/aptos/1" \
...
# # class 2
python generate_fundus_augmentations.py \
--out="./generated_fundus_augs/aptos/2" \
...
# # class 3
python generate_fundus_augmentations.py  \
--out="./generated_fundus_augs/aptos/3" \
...
# class 4
python generate_fundus_augmentations.py \
--out="./generated_fundus_augs/aptos/4" \
